    ...
    public function run(): void
    {
        ...
        $roles = [
            'Manager' => [
                ...
                'view_invoices', 'create_invoices', 'update_invoices', 'register_payments', 'manage_credit_notes',
            ],
            'Sales' => ['view_dashboard', 'create_orders', 'view_reports'],
            'Accountant' => ['manage_accounting', 'view_reports', 'view_invoices', 'create_invoices', 'update_invoices', 'register_payments', 'manage_credit_notes'],
